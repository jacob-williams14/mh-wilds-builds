<script lang="ts">
	...
	const step2Config = $derived.by(() =>
		step1Answer ? (currentData.flow.q2[step1Answer] ?? null) : null
	);
...
<div class="app-shell">
	...
	<section class="flow-shell">
		<div class="section-title">{currentData.flow.title}</div>
		<p class="flow-copy">Each path resolves to one build. Switch weapons or reset at any time.</p>

		<div class="flow-stack">
			<FlowQuestion
				stepLabel="Step 1"
				text={currentData.flow.q1Text}
				options={currentData.flow.q1Options}
