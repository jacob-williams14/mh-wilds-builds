...
| 7 | Tighten data contracts | Not started | [07-tighten-data-contracts.md](./07-tighten-data-contracts.md) |
| 8 | Reorganize `lib/` into `domain/` + `ui/` | Not started | [08-reorganize-lib.md](./08-reorganize-lib.md) |
