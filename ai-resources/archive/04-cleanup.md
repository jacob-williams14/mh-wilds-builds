...
### A. Historical prototype artifacts in `ai-resources/` — **Archived** (pre-Phase-4)
...
### B. PROCESS-add-weapon.md vs phases/00-conventions.md overlap — **Archived** (pre-Phase-4)
...
### C. PLAN.md final reconciliation — **Updated** (thin redirect, current state accurate)
...
### D. Orphaned screenshot files — **None found** (gogma-gore and gore-lord-soul transcribed into reference doc)
...
### E. `.DS_Store` files — **Skip** (gitignored, low priority)
...
### F. README.md (project root) — **Keep** (verified accurate)
...
### G. CLAUDE.md — **Updated** (fixed stale paths, fields, added referenceKey to type table)
